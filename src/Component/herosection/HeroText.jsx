  ...
  return (
    <motion.div
      ...
      variants={{
        ...
        visible: { opacity: 1, y: 0, transition: { staggerChildren: 0.15, duration: 0.5, ease: "easeInOut" } },
      }}
      className="flex flex-col gap-3 md:gap-5 justify-center text-center md:text-left md:ml-16 lg:ml-32"
    >
      <motion.div variants={{ hidden: { opacity: 0, y: -30 }, visible: { opacity: 1, y: 0 } }}>
        <h1 className="font-bold text-white text-3xl md:text-5xl lg:text-6xl">Hi There,</h1>
      ...
      >
        {[{ href: "https://www.linkedin.com/in/rohit-singh-b7777730a/", icon: faLinkedin },
          ...
          { href: "https://www.instagram.com/rohit_coder5/?hl=en", icon: faInstagram }].map(({ href, icon }, index) => (
          <motion.a
            key={index}
            href={href}
            target="_blank"
