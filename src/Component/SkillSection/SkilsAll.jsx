...
import { FaHtml5, FaJs, FaGitAlt, FaDatabase, FaDocker, FaLaravel, FaPhp , FaPython } from "react-icons/fa";
import { SiCss3, SiTailwindcss, SiRedux, SiMongodb, SiExpress, SiTypescript,SiRedis } from "react-icons/si";
...
{ id: "laravel", skill: "Laravel", icon: <FaLaravel className="text-red-500" /> },
{ id: "php", skill: "PHP", icon: <FaPhp className="text-indigo-500" /> },
{ id: "redis", skill: "Redis", icon: <SiRedis className="text-red-600" /> },
